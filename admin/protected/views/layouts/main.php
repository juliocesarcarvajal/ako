	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Categorías', 'url'=>array('category/admin'), 'visible'=>!Yii::app()->user->isGuest),
				array('label'=>'Ejercicios', 'url'=>array('exercise/admin'), 'visible'=>!Yii::app()->user->isGuest),
